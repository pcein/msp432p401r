#[doc = "Reader of register T32BGLOAD2"]
pub type R = crate::R<u32, super::T32BGLOAD2>;
#[doc = "Writer for register T32BGLOAD2"]
pub type W = crate::W<u32, super::T32BGLOAD2>;
#[doc = "Register T32BGLOAD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::T32BGLOAD2 {
    type Type = u32;
    #[inline(always)]
