#[doc = "Reader of register P4MAP45"]
pub type R = crate::R<u16, super::P4MAP45>;
#[doc = "Writer for register P4MAP45"]
pub type W = crate::W<u16, super::P4MAP45>;
#[doc = "Register P4MAP45 `reset()`'s with value 0"]
impl crate::ResetValue for super::P4MAP45 {
    type Type = u16;
    #[inline(always)]
