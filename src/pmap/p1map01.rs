#[doc = "Reader of register P1MAP01"]
pub type R = crate::R<u16, super::P1MAP01>;
#[doc = "Writer for register P1MAP01"]
pub type W = crate::W<u16, super::P1MAP01>;
#[doc = "Register P1MAP01 `reset()`'s with value 0"]
impl crate::ResetValue for super::P1MAP01 {
    type Type = u16;
    #[inline(always)]
