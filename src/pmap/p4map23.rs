#[doc = "Reader of register P4MAP23"]
pub type R = crate::R<u16, super::P4MAP23>;
#[doc = "Writer for register P4MAP23"]
pub type W = crate::W<u16, super::P4MAP23>;
#[doc = "Register P4MAP23 `reset()`'s with value 0"]
impl crate::ResetValue for super::P4MAP23 {
    type Type = u16;
    #[inline(always)]
