#[doc = "Reader of register P7MAP45"]
pub type R = crate::R<u16, super::P7MAP45>;
#[doc = "Writer for register P7MAP45"]
pub type W = crate::W<u16, super::P7MAP45>;
#[doc = "Register P7MAP45 `reset()`'s with value 0"]
impl crate::ResetValue for super::P7MAP45 {
    type Type = u16;
    #[inline(always)]
