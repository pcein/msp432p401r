#[doc = "Reader of register P3MAP67"]
pub type R = crate::R<u16, super::P3MAP67>;
#[doc = "Writer for register P3MAP67"]
pub type W = crate::W<u16, super::P3MAP67>;
#[doc = "Register P3MAP67 `reset()`'s with value 0"]
impl crate::ResetValue for super::P3MAP67 {
    type Type = u16;
    #[inline(always)]
