#[doc = "Reader of register P5MAP23"]
pub type R = crate::R<u16, super::P5MAP23>;
#[doc = "Writer for register P5MAP23"]
pub type W = crate::W<u16, super::P5MAP23>;
#[doc = "Register P5MAP23 `reset()`'s with value 0"]
impl crate::ResetValue for super::P5MAP23 {
    type Type = u16;
    #[inline(always)]
