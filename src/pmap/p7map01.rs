#[doc = "Reader of register P7MAP01"]
pub type R = crate::R<u16, super::P7MAP01>;
#[doc = "Writer for register P7MAP01"]
pub type W = crate::W<u16, super::P7MAP01>;
#[doc = "Register P7MAP01 `reset()`'s with value 0"]
impl crate::ResetValue for super::P7MAP01 {
    type Type = u16;
    #[inline(always)]
