#[doc = "Reader of register P6MAP23"]
pub type R = crate::R<u16, super::P6MAP23>;
#[doc = "Writer for register P6MAP23"]
pub type W = crate::W<u16, super::P6MAP23>;
#[doc = "Register P6MAP23 `reset()`'s with value 0"]
impl crate::ResetValue for super::P6MAP23 {
    type Type = u16;
    #[inline(always)]
