#[doc = "Reader of register P6MAP45"]
pub type R = crate::R<u16, super::P6MAP45>;
#[doc = "Writer for register P6MAP45"]
pub type W = crate::W<u16, super::P6MAP45>;
#[doc = "Register P6MAP45 `reset()`'s with value 0"]
impl crate::ResetValue for super::P6MAP45 {
    type Type = u16;
    #[inline(always)]
