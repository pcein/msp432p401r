#[doc = "Reader of register DMA_INT2_SRCCFG"]
pub type R = crate::R<u32, super::DMA_INT2_SRCCFG>;
#[doc = "Writer for register DMA_INT2_SRCCFG"]
pub type W = crate::W<u32, super::DMA_INT2_SRCCFG>;
#[doc = "Register DMA_INT2_SRCCFG `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_INT2_SRCCFG {
    type Type = u32;
    #[inline(always)]
