#[doc = "Reader of register FLCTL_PRGBRST_STARTADDR"]
pub type R = crate::R<u32, super::FLCTL_PRGBRST_STARTADDR>;
#[doc = "Writer for register FLCTL_PRGBRST_STARTADDR"]
pub type W = crate::W<u32, super::FLCTL_PRGBRST_STARTADDR>;
#[doc = "Register FLCTL_PRGBRST_STARTADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::FLCTL_PRGBRST_STARTADDR {
    type Type = u32;
    #[inline(always)]
