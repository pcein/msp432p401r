#[doc = "Writer for register FLCTL_CLRIFG"]
pub type W = crate::W<u32, super::FLCTL_CLRIFG>;
#[doc = "Register FLCTL_CLRIFG `reset()`'s with value 0"]
impl crate::ResetValue for super::FLCTL_CLRIFG {
    type Type = u32;
    #[inline(always)]
