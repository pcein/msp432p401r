#[doc = "Reader of register FLCTL_BANK1_INFO_WEPROT"]
pub type R = crate::R<u32, super::FLCTL_BANK1_INFO_WEPROT>;
#[doc = "Writer for register FLCTL_BANK1_INFO_WEPROT"]
pub type W = crate::W<u32, super::FLCTL_BANK1_INFO_WEPROT>;
#[doc = "Register FLCTL_BANK1_INFO_WEPROT `reset()`'s with value 0x03"]
impl crate::ResetValue for super::FLCTL_BANK1_INFO_WEPROT {
    type Type = u32;
    #[inline(always)]
