#[doc = "Reader of register UCAxTXBUF"]
pub type R = crate::R<u16, super::UCAXTXBUF>;
#[doc = "Writer for register UCAxTXBUF"]
pub type W = crate::W<u16, super::UCAXTXBUF>;
#[doc = "Register UCAxTXBUF `reset()`'s with value 0"]
impl crate::ResetValue for super::UCAXTXBUF {
    type Type = u16;
    #[inline(always)]
