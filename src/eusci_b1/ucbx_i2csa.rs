#[doc = "Reader of register UCBxI2CSA"]
pub type R = crate::R<u16, super::UCBXI2CSA>;
#[doc = "Writer for register UCBxI2CSA"]
pub type W = crate::W<u16, super::UCBXI2CSA>;
#[doc = "Register UCBxI2CSA `reset()`'s with value 0"]
impl crate::ResetValue for super::UCBXI2CSA {
    type Type = u16;
    #[inline(always)]
