#[doc = "Reader of register UCBxTXBUF"]
pub type R = crate::R<u16, super::UCBXTXBUF>;
#[doc = "Writer for register UCBxTXBUF"]
pub type W = crate::W<u16, super::UCBXTXBUF>;
#[doc = "Register UCBxTXBUF `reset()`'s with value 0"]
impl crate::ResetValue for super::UCBXTXBUF {
    type Type = u16;
    #[inline(always)]
