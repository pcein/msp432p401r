#[doc = "Reader of register UCBxTBCNT"]
pub type R = crate::R<u16, super::UCBXTBCNT>;
#[doc = "Writer for register UCBxTBCNT"]
pub type W = crate::W<u16, super::UCBXTBCNT>;
#[doc = "Register UCBxTBCNT `reset()`'s with value 0"]
impl crate::ResetValue for super::UCBXTBCNT {
    type Type = u16;
    #[inline(always)]
