#[doc = "Reader of register UCAxCTLW1"]
pub type R = crate::R<u16, super::UCAXCTLW1>;
#[doc = "Writer for register UCAxCTLW1"]
pub type W = crate::W<u16, super::UCAXCTLW1>;
#[doc = "Register UCAxCTLW1 `reset()`'s with value 0x03"]
impl crate::ResetValue for super::UCAXCTLW1 {
    type Type = u16;
    #[inline(always)]
