#[doc = "Reader of register UCAxIFG"]
pub type R = crate::R<u16, super::UCAXIFG>;
#[doc = "Writer for register UCAxIFG"]
pub type W = crate::W<u16, super::UCAXIFG>;
#[doc = "Register UCAxIFG `reset()`'s with value 0x02"]
impl crate::ResetValue for super::UCAXIFG {
    type Type = u16;
    #[inline(always)]
