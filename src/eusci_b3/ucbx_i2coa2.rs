#[doc = "Reader of register UCBxI2COA2"]
pub type R = crate::R<u16, super::UCBXI2COA2>;
#[doc = "Writer for register UCBxI2COA2"]
pub type W = crate::W<u16, super::UCBXI2COA2>;
#[doc = "Register UCBxI2COA2 `reset()`'s with value 0"]
impl crate::ResetValue for super::UCBXI2COA2 {
    type Type = u16;
    #[inline(always)]
